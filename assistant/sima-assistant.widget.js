(function () {
  ...
  function injectStyles() {
    ...
    style.textContent = [
      ...
      '  --sima-musgo: #0C505B;',
      '  --sima-lima: #DDF972;',
      '  --sima-esmeralda: #CBEFE1;',
      '  --sima-blanco: #F3F7F8;',
      '  --sima-primary: var(--sima-azul);',
      '  --sima-primary-light: var(--sima-musgo);',
      '  --sima-primary-dark: var(--sima-azul);',
      '  --sima-accent: var(--sima-lima);',
      '  --sima-surface: #ffffff;',
      '  --sima-bg: var(--sima-blanco);',
      '  --sima-text: var(--sima-azul);',
      '  --sima-muted: var(--sima-musgo);',
      '  --sima-border: rgba(0, 37, 46, 0.12);',
      '  --sima-bubble: #ffffff;',
      '  --sima-code-bg: var(--sima-blanco);',
      '  --sima-shadow: 0 12px 48px rgba(0, 37, 46, 0.15);',
      ...
      '  --sima-surface: var(--sima-musgo);',
      '  --sima-bg: var(--sima-azul);',
      '  --sima-text: var(--sima-blanco);',
      '  --sima-muted: var(--sima-esmeralda);',
      '  --sima-border: rgba(243, 247, 248, 0.15);',
      '  --sima-bubble: rgba(12, 80, 91, 0.6);',
      '  --sima-code-bg: var(--sima-azul);',
      '  --sima-shadow: 0 12px 48px rgba(0, 0, 0, 0.45);',
      '}',
      '#sima-assistant-trigger, #sima-assistant-panel { pointer-events: auto; }',
      '#sima-assistant-trigger {',
      '  position: fixed; bottom: 24px; right: 24px; width: 56px; height: 56px;',
      '  border-radius: 50%; border: none; background: var(--sima-accent); color: var(--sima-azul);',
      '  cursor: pointer; box-shadow: 0 4px 20px rgba(221, 249, 114, 0.35);',
      '  display: flex; align-items: center; justify-content: center;',
      '  transition: transform .2s, background .2s;',
      '}',
      '#sima-assistant-trigger:hover { background: var(--sima-esmeralda); transform: scale(1.05); }',
      ...
      '  background: linear-gradient(135deg, var(--sima-azul), var(--sima-musgo));',
      '  color: var(--sima-blanco); padding: 16px 18px; display: flex; align-items: flex-start;',
      ...
      '  background: rgba(243, 247, 248, 0.15); border: none; color: var(--sima-blanco); width: 28px; height: 28px;',
      ...
      '.sima-msg.user {',
      '  align-self: flex-end; background: var(--sima-primary); color: var(--sima-blanco);',
      ...
      '.sima-sources a { color: var(--sima-musgo); text-decoration: none; display: block; margin-top: 4px; }',
      ...
      '  color: var(--sima-musgo); cursor: pointer;',
      '}',
      '.sima-example-btn:hover { border-color: var(--sima-accent); background: rgba(221, 249, 114, 0.2); }',
      ...
      '#sima-assistant-input:focus { border-color: var(--sima-primary); box-shadow: 0 0 0 3px rgba(0, 37, 46, 0.15); }',
      '#sima-assistant-send {',
      '  background: var(--sima-accent); color: var(--sima-azul); border: none; border-radius: 10px;',
      '  padding: 0 16px; cursor: pointer; font-weight: 600; font-size: 14px;',
      '}',
      '#sima-assistant-send:hover:not(:disabled) { background: var(--sima-esmeralda); }',
      ...
      '}',
      '#sima-assistant-footer a { color: var(--sima-musgo); }',
