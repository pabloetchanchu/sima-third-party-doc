---
title: "Sync Strategy"
description: "How to efficiently detect and pull changes from SIMA using audit filters — without re-fetching everything every time"
---
